...
/**
 * Main controller: get yesterday's order statistics
 */
export async function getYesterdayStats(req, res) {
  try {
    const user = req.user;
    ...
    const result = await buildStats(user.shop_domain, start, end, "yesterday");
